...
class Network(object):
  ...
  def _add_losses(self, sigma_rpn=3.0):
    with tf.variable_scope('loss_' + self._tag) as scope:
      ...
      #total loss
      loss = cross_entropy + loss_box + rpn_cross_entropy + rpn_loss_box + rpn1_cross_entropy*0.01 + rpn2_cross_entropy*0.001
  ...
  def train_step(self, sess, blobs, train_op):
    feed_dict = {self._image: blobs['data'], self._im_info: blobs['im_info'],
                 self._gt_boxes: blobs['gt_boxes']}
    rpn2_loss_cls, rpn1_loss_cls, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss, _ = sess.run([
                                                                                                                                                      ...
                                                                                                                                                      train_op],
                                                                                                                                                      feed_dict=feed_dict)
    return rpn2_loss_cls, rpn1_loss_cls, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss
  ...
  def train_step_with_summary(self, sess, blobs, train_op):
    ...
    rpn2_loss_cls, rpn1_loss_cls, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss, summary, _ = sess.run([
                                                                                                                                                               self._losses["rpn2_cross_entropy"],
                                                                                                                                                               self._losses["rpn1_cross_entropy"],
                                                                                                                                                               self._losses["rpn_cross_entropy"],
                                                                                                                                                               self._losses['rpn_loss_box'],
                                                                                                                                                               ...
                                                                                                                                                               train_op],
                                                                                                                                                               feed_dict=feed_dict)
    return rpn2_loss_cls, rpn1_loss_cls, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss, summary
