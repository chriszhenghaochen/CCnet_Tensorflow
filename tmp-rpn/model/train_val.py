  ...
  def train_model(self, sess, max_iters):
    ...
    while iter < max_iters + 1:
      ...
      if now - last_summary_time > cfg.TRAIN.SUMMARY_INTERVAL:
        ...
        rpn3_loss_cls, rpn2_loss_cls, rpn1_loss_cls, rpn0_loss_cls, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, total_loss, summary = \
        ...
        rpn3_loss_cls, rpn2_loss_cls, rpn1_loss_cls, rpn0_loss_cls, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, total_loss = \
      ...
      if iter % (cfg.TRAIN.DISPLAY) == 0:
        print('iter: %d / %d, total loss: %.6f\n >>> rpn3_loss_cls: %.6f\n >>> rpn2_loss_cls: %.6f\n >>> rpn1_loss_cls: %.6f\n'
              ' >>> rpn0_loss_cls: %.6f\n >>> rpn_loss_cls: %.6f\n >>> rpn_loss_box: %.6f\n >>> loss_cls: %.6f\n >>> loss_box: %.6f\n >>> lr: %f' % \
              (iter, max_iters, total_loss, rpn3_loss_cls, rpn2_loss_cls, rpn1_loss_cls, rpn0_loss_cls, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, lr.eval()))
