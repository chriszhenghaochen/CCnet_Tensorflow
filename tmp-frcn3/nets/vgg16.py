...
class vgg16(Network):
  ...
  def build_network(self, sess, is_training=True):
    with tf.variable_scope('vgg_16', 'vgg_16'):
      ...
      pool41_conv = slim.conv2d(pool41, 512, [1, 1], trainable=is_training, weights_initializer=initializer, scope="pool41_conv")
      ...
      cls_score = cls4_score*0.25 + cls5_score*0.25 + cls0_score*0.25
