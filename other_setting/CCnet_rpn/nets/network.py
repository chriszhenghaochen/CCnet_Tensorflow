...
class Network(object):
  ...
  def _add_losses(self, sigma_rpn=3.0):
    with tf.variable_scope('loss_' + self._tag) as scope:
      ...
      #total loss
      loss = cross_entropy + loss_box + rpn_cross_entropy + rpn0_cross_entropy*0.1 + rpn_loss_box + rpn1_cross_entropy*0.01 + rpn2_cross_entropy*0.001+ rpn3_cross_entropy*0.0001
  ...
  def train_step(self, sess, blobs, train_op):
    ...
    rpn3_loss_cls, rpn2_loss_cls, rpn1_loss_cls, rpn0_loss_cls, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss, _ = sess.run([self._losses["rpn3_cross_entropy"],
                                                                                                                                                      ...
                                                                                                                                                      train_op],
                                                                                                                                                      feed_dict=feed_dict)
    return rpn3_loss_cls, rpn2_loss_cls, rpn1_loss_cls, rpn0_loss_cls, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss
