...
class vgg16(Network):
  ...
  def build_network(self, sess, is_training=True):
    with tf.variable_scope('vgg_16', 'vgg_16'):
      ...
      pool4_flat = slim.flatten(pool41, scope='flatten_4')

      fc6_1 = slim.fully_connected(pool4_flat, 4096, scope='fc6_1', trainable = is_training)
      if is_training:
        fc6_1 = slim.dropout(fc6_1, keep_prob=0.5, is_training=True, scope='dropout6_1')
      fc7_1 = slim.fully_connected(fc6_1, 4096, scope='fc7_1', trainable = is_training)
      if is_training:
        fc7_1 = slim.dropout(fc7_1, keep_prob=0.5, is_training=True, scope='dropout7_1')

      fc7_1_scale = self.scale(fc7_1, 0.5, "fc7_1_scale", True)

      cls4_score = slim.fully_connected(fc7_1_scale, self._num_classes,
                                       weights_initializer=initializer,
                                       trainable=is_training,
                                       activation_fn=None, scope='cls4_score')

      self._predictions['cls4_score'] = cls4_score

      cls4_score_scale = self.scale(cls4_score, 0.5, "cls4_score_scale", True)
      ...
      if if_concat:
        fc7 = tf.concat([fc7, fc7_1_scale], 1, 'fc7_concat')
      ...
      self._predictions['cls5_score'] = cls5_score
      ...
      cls_score = tf.add(cls5_score, cls4_score_scale, "cls_score")
  ...
  def get_variables_to_restore(self, variables, var_keep_dic):
    ...
    for v in variables:
      ...
      #restore new fc layer!
      if v.name == 'vgg_16/fc6_1/weights:0' or v.name == 'vgg_16/fc7_1/weights:0' or v.name == 'vgg_16/fc6_1/biases:0' or v.name == 'vgg_16/fc7_1/biases:0' :
        self._variables_to_fix[v.name] = v
        continue
  ...
  def fix_variables(self, sess, pretrained_model):
    ...
    with tf.variable_scope('Fix_VGG16') as scope:
      with tf.device("/cpu:0"):
        ...
        fc7_bias = tf.get_variable("fc7_bias", [4096], trainable=False)

        conv1_rgb = tf.get_variable("conv1_rgb", [3, 3, 3, 64], trainable=False)
        restorer_fc = tf.train.Saver({"vgg_16/fc6/weights": fc6_conv, 
                                      "vgg_16/fc6/biases": fc6_bias,
                                      "vgg_16/fc7/weights": fc7_conv,
                                      "vgg_16/fc7/biases": fc7_bias,
        ...
        sess.run(tf.assign(self._variables_to_fix['vgg_16/fc6_1/weights:0'], tf.reshape(fc6_conv, 
                            self._variables_to_fix['vgg_16/fc6_1/weights:0'].get_shape())))
        sess.run(tf.assign(self._variables_to_fix['vgg_16/fc7_1/weights:0'], tf.reshape(fc7_conv, 
                            self._variables_to_fix['vgg_16/fc7_1/weights:0'].get_shape())))
        ...
        sess.run(tf.assign(self._variables_to_fix['vgg_16/fc7_1/biases:0'], tf.reshape(fc7_bias, 
                            self._variables_to_fix['vgg_16/fc7_1/biases:0'].get_shape())))
