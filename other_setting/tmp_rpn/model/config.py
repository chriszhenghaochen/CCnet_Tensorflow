...
#REJECT FACTOR
__C.RPN_REJECT3_FACTOR = 0
__C.RPN_REJECT2_FACTOR = 0
__C.RPN_REJECT1_FACTOR = 0

__C.REJECT3_FACTOR = 0
__C.REJECT2_FACTOR = 0
__C.REJECT1_FACTOR = 0


#CHAIN SCORE FACTOR
__C.SCORE_FACTOR1 = 0.1
__C.SCORE_FACTOR2 = 0.9
...
__C.TRAIN.OHEM3 = False
__C.TRAIN.OHEM2 = False
