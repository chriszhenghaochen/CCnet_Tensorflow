...
class vgg16(Network):
  ...
  def build_network(self, sess, is_training=True):
    with tf.variable_scope('vgg_16', 'vgg_16'):
      ...
      cls_score = tf.add_n([cls3_score*cls3_score_scale*0.1, cls4_score*cls2_score_scale*0.2, cls5_score*cls1_score_scale*0.3, cls0_score*cls0_score_scale*0.4], name = 'final_cls_score')
