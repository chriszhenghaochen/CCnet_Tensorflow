...
class Network(object):
  ...
  def _add_losses(self, sigma_rpn=3.0):
    with tf.variable_scope('loss_' + self._tag) as scope:
      ...
      #total loss
      loss = cross_entropy + cross_entropy0*0.1 + loss_box + rpn_cross_entropy + rpn0_cross_entropy*0.1 + rpn_loss_box + cross_entropy1*0.05 + cross_entropy2*0.025 + rpn1_cross_entropy*0.05+ rpn2_cross_entropy*0.025
  ...
  def train_step(self, sess, blobs, train_op):
    feed_dict = {self._image: blobs['data'], self._im_info: blobs['im_info'],
                 self._gt_boxes: blobs['gt_boxes']}
    rpn2_loss_cls, rpn1_loss_cls, rpn0_loss_cls, loss_cls2, loss_cls1, loss_cls0, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss, _ = sess.run([
                                                                                                                                                      ...
                                                                                                                                                      train_op],
                                                                                                                                                      feed_dict=feed_dict)
    return rpn2_loss_cls, rpn1_loss_cls, rpn0_loss_cls, loss_cls2, loss_cls1, loss_cls0, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss
  ...
  def train_step_with_summary(self, sess, blobs, train_op):
    ...
    rpn2_loss_cls, rpn1_loss_cls, rpn0_loss_cls, loss_cls2, loss_cls1, loss_cls0, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss, summary, _ = sess.run([
                                                                                                                                                               self._losses["rpn2_cross_entropy"],
                                                                                                                                                               self._losses["rpn1_cross_entropy"],
                                                                                                                                                               self._losses["rpn0_cross_entropy"],
                                                                                                                                                               ...
                                                                                                                                                               train_op],
                                                                                                                                                               feed_dict=feed_dict)
    return rpn2_loss_cls, rpn1_loss_cls, rpn0_loss_cls, loss_cls2, loss_cls1, loss_cls0, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, loss, summary
