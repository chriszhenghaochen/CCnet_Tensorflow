...
class vgg16(Network):
  ...
  def build_network(self, sess, is_training=True):
    with tf.variable_scope('vgg_16', 'vgg_16'):
      ...
      # pool41_norm = self.l2_norm(pool41_flat, 1, 10.0, 'pool41_norm', is_training)
      ...
      # pool_norm = self.l2_norm(pool_avg_flat, 1, 10.0, 'pool_norm', is_training)
      ...
      fc7_norm = self.l2_norm(fc7, 1, 30.0, 'fc7_norm', False)
      #fc7_norm = self.normalize_to_target(fc7, 10.0, 1, 'fc7_norm')

      # fc7_concat = tf.concat([fc7_norm, pool_norm, pool41_norm], 1, 'fc7_concat')

      cls_score = slim.fully_connected(fc7_norm, self._num_classes,
                                       weights_initializer=initializer,
                                       trainable=is_training,
                                       activation_fn=None, scope='cls_score')


      bbox_pred = slim.fully_connected(fc7_norm, self._num_classes * 4,
