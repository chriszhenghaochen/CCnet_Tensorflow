...
class vgg16(Network):
  ...
  def build_network(self, sess, is_training=True):
    with tf.variable_scope('vgg_16', 'vgg_16'):
      ...
      fc6 = slim.fully_connected(pool4_flat, 4096, scope='fc6')
      if is_training:
      ...
      cls4_score = slim.fully_connected(fc7, self._num_classes,
                                       weights_initializer=initializer,
      ...
      fc6 = slim.fully_connected(pool_flat, 4096, scope='fc6', reuse = True)
      if is_training:
        fc6 = slim.dropout(fc6, keep_prob=0.5, is_training=True, scope='dropout6_1')
      fc7 = slim.fully_connected(fc6, 4096, scope='fc7', reuse = True)
      if is_training:
        fc7 = slim.dropout(fc7, keep_prob=0.5, is_training=True, scope='dropout7_1')
